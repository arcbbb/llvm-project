...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %7 = select i1 undef, <32 x i1> undef, <32 x i1> undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %13 = select <32 x i1> undef, <32 x i1> undef, <32 x i1> undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %32 = select i1 undef, <32 x i8> undef, <32 x i8> undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %56 = select i1 undef, <16 x i16> undef, <16 x i16> undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %57 = select i1 undef, <32 x i16> undef, <32 x i16> undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %80 = select i1 undef, <8 x i32> undef, <8 x i32> undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %81 = select i1 undef, <16 x i32> undef, <16 x i32> undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %82 = select i1 undef, <32 x i32> undef, <32 x i32> undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %94 = select i1 undef, <vscale x 32 x i32> undef, <vscale x 32 x i32> undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %104 = select i1 undef, <4 x i64> undef, <4 x i64> undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %105 = select i1 undef, <8 x i64> undef, <8 x i64> undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %106 = select i1 undef, <16 x i64> undef, <16 x i64> undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %107 = select i1 undef, <32 x i64> undef, <32 x i64> undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %118 = select i1 undef, <vscale x 16 x i64> undef, <vscale x 16 x i64> undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %119 = select i1 undef, <vscale x 32 x i64> undef, <vscale x 32 x i64> undef
